...
Během trénování modelu byly každou epochu měřeny metriky. Při trénování a validaci byla počítána přesnost pro vzorek a ztráta pro vzorek \note{pro jeden vzorek? není to přesnost na úrovni framů?} 
Při validaci byla navíc zaznamenávána i přesnost pro nahrávku, kdy byla předpověď pro jednu nahrávku vypočtena zprůměrováním výstupů sítě pro každý vzorek nahrávky.
