...
Vícevrství perceptron neboli feed-forward neural network je složen z více vrstev logických regresí nasledovanými nelineárními vrstvami. Lineární vrstva se skládá z parametrů vah a biasů. Při vstupu příznaků do lineární vrstvy se příznaky nejdříve maticově vynásobí s váhami, a potom je k nim přičten bias. Dále jsou příznaky aktivovány nelineární funkcí\cite{DBLP:books/lib/Bishop07}. 
